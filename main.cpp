...
//デバックレイヤーをオンに
	...
	depthResourceDesc.Width = WinApp::WIN_WIDTH;//レンダーターゲットに合わせる
	depthResourceDesc.Height = WinApp::WIN_HEIGHT;//レンダーターゲットに合わせる
	...
	result = LoadFromWICFile(
		L"Resources/bb.png",   //「Resources」フォルダの「bb.png」
		WIC_FLAGS_NONE,
		&metadata, scratchImg);
